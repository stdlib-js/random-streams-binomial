...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a binomial distribution', function test( t ) {
	var iStream;
	var result;
	var rand;
	var opts;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a binomial distribution (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
...
tape( 'the constructor supports returning a seeded readable stream', function test( t ) {
	...
	s1 = randomStream( 20, 0.3, opts );
	s1.on( 'end', onEnd1 );

	s2 = randomStream( 20, 0.3, opts );
	s2.on( 'end', onEnd2 );
